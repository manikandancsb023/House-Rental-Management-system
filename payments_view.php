...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->ColWidth   = array(  150, 150, 150, 150, 150, 150, 150, 150, 100);
	$x->ColCaption = array("Tenant", "House", "Year", "Month", "Expected amount (Ksh)", "Paid amount (Ksh)", "Balance (Ksh)", "Date", "sms");
	$x->ColFieldName = array('tenant', 'house', 'year', 'month', 'expected_amount', 'paid_amount', 'balance', 'date', 'sms');
